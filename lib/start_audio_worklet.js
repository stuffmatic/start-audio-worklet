...
function startAudioWorklet(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sampleRate = (_a = options.sampleRate) !== null && _a !== void 0 ? _a : 44100; // 44.1kHz sample rate by default
        const latencyHint = (_b = options.latencyHint) !== null && _b !== void 0 ? _b : "interactive";
        let contextOptions = { sampleRate, latencyHint };
        let context;
        ...
        const microphoneMode = (_c = options.microphoneMode) !== null && _c !== void 0 ? _c : MicrophoneMode.required;
        let micStream = null;
        const atLeastOneInputIsRequested = (_d = options.workletNodeOptions.numberOfInputs) !== null && _d !== void 0 ? _d : 0 > 0;
